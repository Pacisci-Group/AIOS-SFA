...
- **1 prototype dashboard remains** (service). It
  is **not** light-theme clean and is not meant to be — it is slated for
  replacement, and it still references `--navy-900`, `--emerald`, `--red`,
