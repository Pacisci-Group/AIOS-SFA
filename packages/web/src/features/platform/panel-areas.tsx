 ...
 *
 * **Onboard Agency** (PAC-69), **Find / Impersonate User** (PAC-70) and **Add
 * Mailers** are live. The rest are shown disabled with "Coming soon" so the
 * shape of the product reads at a glance — hiding them would hide the roadmap
 * from the people the panel is for. Nothing navigates anywhere it cannot go, and
 * there are no fake screens behind any of them.
 *
